...
/**
 * Servlet implementation class MongoUserServlet
 */
public class MongoUserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ("joinform".equals(action)) {
			...
			new MongoUserDao().insert(userVo);
			...
			UserVo authUser = new MongoUserDao().findByEmailAndPassword(vo);
			if (authUser == null) {
			...
			UserVo userVo = new MongoUserDao().findByNo(no);
