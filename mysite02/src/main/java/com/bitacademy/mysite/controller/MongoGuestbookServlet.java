...
import com.bitacademy.mysite.dao.MongoGuestbookDao;
import com.bitacademy.mysite.vo.GuestbookVo;
import com.bitacademy.web.mvc.WebUtil;

public class MongoGuestbookServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ("deleteform".equals(action)) {
			...
			new MongoGuestbookDao().insert(vo);
			...
			new MongoGuestbookDao().delete(pw, no);
			WebUtil.redirect(request.getContextPath() + "/guestbook", request, response);
		}

		else {
			List<GuestbookVo> list = new MongoGuestbookDao().findAll();
